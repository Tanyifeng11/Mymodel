#!/bin/bash
#SBATCH -J E19_A_pattern
#SBATCH -p gpu
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --mem=64G
#SBATCH --gres=gpu:1
#SBATCH -o /share/home/u2515283058/Mymodel/e19/e19_a_%j.log
#SBATCH -e /share/home/u2515283058/Mymodel/e19/e19_a_%j.err
set -eo pipefail
...
python -m tools.e19_handcrafted \
  ...
  --output "${ROOT}/e19/a" --device cuda:0
