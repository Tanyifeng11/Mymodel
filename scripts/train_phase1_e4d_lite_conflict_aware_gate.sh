...
E4B_CKPT="${E4B_CKPT:-${OUTPUT_BASE}/phase1_e4b_boundary_fid_safe_e1/checkpoint-final/joint_model.pt}"
OUTPUT_DIR="${E4D_OUTPUT_DIR:-${OUTPUT_BASE}/phase1_e4d_lite_conflict_aware_gate_v2_e1}"
...
NUM_TRAIN_EPOCHS="${E4D_NUM_TRAIN_EPOCHS:-1}"
MAX_TRAIN_STEPS="${E4D_MAX_TRAIN_STEPS:--1}"
CHECKPOINTING_EPOCHS="${GAM_CHECKPOINTING_EPOCHS:-1}"
LEARNING_RATE="${E4D_LEARNING_RATE:-5e-6}"
...
USE_CONFLICT_AWARE_GATE="${USE_CONFLICT_AWARE_GATE:-1}"
...
WANDB_RUN_NAME="${E4D_WANDB_RUN_NAME:-phase1_e4d_lite_conflict_aware_gate_v2_e1}"
...
echo "============================================"
echo "Phase E4D-lite conflict-aware balanced gate training"
echo "E4B_CKPT=${E4B_CKPT}"
