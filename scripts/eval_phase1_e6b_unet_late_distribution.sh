...
E6B_CKPT="${E6B_CKPT:-${OUTPUT_BASE}/phase1_e6b_unet_late_dist_e1/checkpoint-final/joint_model.pt}"

EVAL_BASE="${EVAL_BASE:-${PROJECT_ROOT}/eval_outputs/phase1_full_500}"
REPORT_DIR="${REPORT_DIR:-${EVAL_BASE}/report_e6b_unet_late_distribution}"
NUM_SAMPLES="${NUM_SAMPLES:-500}"
EVAL_SEED="${EVAL_SEED:-42}"
EVAL_DEVICE="${EVAL_DEVICE:-cuda:0}"
REPORT_DEVICE="${REPORT_DEVICE:-cuda:0}"
CLIP_MODEL="${CLIP_MODEL:-${PROJECT_ROOT}/models/clip}"
E6B_RUN_NAME="${E6B_RUN_NAME:-e6b_unet_late_distribution}"
EXPERIMENT_NAMES="${EXPERIMENT_NAMES:-e2b_color_safe_gate,e5_tcpm_lite,e6b_unet_late_distribution}"
...
for required_path in "${DATASET_JSON}" "${DATA_ROOT_PATH}" "${TEXTURE_ADAPTER_CKPT}" "${E6B_CKPT}" "${CLIP_MODEL}"; do
...
echo "============================================"
echo "Phase 1 E6b UNet late distribution 500-sample evaluation"
echo "E6B_CKPT=${E6B_CKPT}"
echo "EVAL_BASE=${EVAL_BASE}"
echo "E6B_RUN_NAME=${E6B_RUN_NAME}"
...
echo "============================================"
echo "E6b evaluation done."
echo "Generated images and metrics: ${EVAL_BASE}/${E6B_RUN_NAME}"
