...
OUTPUT_DIR="${E3A_OUTPUT_DIR:-${OUTPUT_BASE}/phase1_e3a_palette_token_e3}"
...
NUM_TRAIN_EPOCHS="${E3A_NUM_TRAIN_EPOCHS:-3}"
MAX_TRAIN_STEPS="${E3A_MAX_TRAIN_STEPS:--1}"
CHECKPOINTING_EPOCHS="${GAM_CHECKPOINTING_EPOCHS:-1}"
LEARNING_RATE="${E3A_LEARNING_RATE:-1e-5}"
...
WANDB_RUN_NAME="${E3A_WANDB_RUN_NAME:-phase1_e3a_palette_token_e3}"
...
echo "============================================"
echo "Phase E3A Palette Token training"
echo "E2A_CKPT=${E2A_CKPT}"
echo "TEXTURE_ADAPTER_CKPT=${TEXTURE_ADAPTER_CKPT}"
echo "OUTPUT_DIR=${OUTPUT_DIR}"
echo "NUM_PALETTE_TOKENS=${NUM_PALETTE_TOKENS}, PALETTE_MLP_LR=${PALETTE_MLP_LR}"
echo "LAMBDA_REGION_TEXTURE=${LAMBDA_REGION_TEXTURE}, LAMBDA_REGION_COLOR_LAB=${LAMBDA_REGION_COLOR_LAB}, LAMBDA_BOUNDARY=${LAMBDA_BOUNDARY}, LAMBDA_LEAK=${LAMBDA_LEAK}"
echo "============================================"
printf '%q ' "${CMD[@]}"
echo
