...
E5B_CKPT="${E5B_CKPT:-${OUTPUT_BASE}/phase1_e5b_tcpm_detail_adapter_e1/checkpoint-final/joint_model.pt}"

EVAL_BASE="${EVAL_BASE:-${PROJECT_ROOT}/eval_outputs/phase1_full_500}"
REPORT_DIR="${REPORT_DIR:-${EVAL_BASE}/report_e5b_tcpm_detail_adapter}"
NUM_SAMPLES="${NUM_SAMPLES:-500}"
EVAL_SEED="${EVAL_SEED:-42}"
EVAL_DEVICE="${EVAL_DEVICE:-cuda:0}"
REPORT_DEVICE="${REPORT_DEVICE:-cuda:0}"
CLIP_MODEL="${CLIP_MODEL:-${PROJECT_ROOT}/models/clip}"
EXPERIMENT_NAMES="${EXPERIMENT_NAMES:-e2b_color_safe_gate,e5_tcpm_lite,e5b_tcpm_detail_adapter}"
...
for required_path in "${DATASET_JSON}" "${DATA_ROOT_PATH}" "${TEXTURE_ADAPTER_CKPT}" "${E5B_CKPT}" "${CLIP_MODEL}"; do
...
echo "============================================"
echo "Phase 1 E5b TCPM-lite + detail adapter 500-sample evaluation"
echo "E5B_CKPT=${E5B_CKPT}"
...
echo "============================================"
echo "E5b evaluation done."
echo "Generated images and metrics: ${EVAL_BASE}/e5b_tcpm_detail_adapter"
