...
OUTPUT_DIR="${E4A_OUTPUT_DIR:-${OUTPUT_BASE}/phase1_e4a_balanced_gate_e3}"
...
NUM_TRAIN_EPOCHS="${E4A_NUM_TRAIN_EPOCHS:-3}"
MAX_TRAIN_STEPS="${E4A_MAX_TRAIN_STEPS:--1}"
CHECKPOINTING_EPOCHS="${GAM_CHECKPOINTING_EPOCHS:-1}"
LEARNING_RATE="${E4A_LEARNING_RATE:-1e-5}"
PALETTE_MLP_LR="${PALETTE_MLP_LR:-5e-5}"
...
BALANCED_GATE_REG_WEIGHT="${BALANCED_GATE_REG_WEIGHT:-1e-4}"

REPORT_TO="${REPORT_TO:-wandb}"
WANDB_PROJECT="${WANDB_PROJECT:-Mymodel}"
WANDB_RUN_NAME="${E4A_WANDB_RUN_NAME:-phase1_e4a_balanced_gate_e3}"
...
echo "============================================"
echo "Phase E4A Text-Texture Balanced Fusion Gate training"
echo "E3A_CKPT=${E3A_CKPT}"
echo "TEXTURE_ADAPTER_CKPT=${TEXTURE_ADAPTER_CKPT}"
echo "OUTPUT_DIR=${OUTPUT_DIR}"
echo "BALANCED_GATE_SCALE=${BALANCED_GATE_SCALE}, BALANCED_GATE_RANGE=[${BALANCED_GATE_MIN}, ${BALANCED_GATE_MAX}]"
