...
LAMBDA_REGION_TEXTURE="${LAMBDA_REGION_TEXTURE:-0.2}"
LAMBDA_BOUNDARY="${LAMBDA_BOUNDARY:-0.05}"
LAMBDA_LEAK="${LAMBDA_LEAK:-0.2}"
...
GATE_REG_WEIGHT="${GATE_REG_WEIGHT:-1e-4}"
...
WANDB_RUN_NAME="${WANDB_RUN_NAME:-phase1_e2b_layer_gate_e3}"
